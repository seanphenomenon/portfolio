                    ...
                    <div className='w-100'>
                        ...
                        <div className="resume-item d-flex flex-column flex-md-row justify-content-center">
                            <div className="p-2 mr-2" id='interest-info'>
                                <p>Outside of being a web developer, I enjoy playing my acoustic guitar, trying new food spots, supporting local artists & businesses, and spending quality time with friends and family. </p>
                        </div>
