      ...
      <div>
        <section id="page-top">
          ...
          <div className="container">
            <p className="d-flex justify-content-center align mb-5" id="quote">
          ...
          <p className="mb-5" id="about-me">
            ...
            While my path to web development is filled with plenty of twists and
            turns, my experiences have shaped me into what I believe is an asset
            within a work setting. <br />
            ...
            District, working closely with the Vice Chancellor, and I was noted
            for quickly learning the ins and outs of the Development Services
            ...
            bootcamp graduate, I am excited to dive into what lays ahead,
