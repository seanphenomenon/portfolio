      ...
      <div className="container-fluid p-4 p-lg-5  max-auto">
        <div className="w-100">
          <section className="p-3 align-items-center" id="page-top">
            ...
            <h1 className="mb-0 justify-content-center mt-2" id="firstName">
              Sean
              <span className="p-1" id="lastName">
                Harrell
              </span>
            </h1>
            <div className="subheading mb-5 " id="phone">
              {" "}
              <span
                role="img"
            ...
            <div>
              <p className="mr-4 d-flex justify-content-center mb-5" id="quote">
                Inspired by imagination. Driven by results.
              </p>
            </div>
            <p className="mb-5" id="about-me">
              {" "}
              ...
              and turns, my experiences have shaped me into what I believe is an
              asset within a work setting. <br />
              ...
              semi-sensitive responsibilities for San Diego's Community College
              District, working closely with the Vice Chancellor, and I was
              noted for quickly learning the ins and outs of the Development
              Services systems for the City of San Diego. <br />
              <br />
              While I enjoy collaborative team-settings where creativity can be
              exchanged, I am dependable as a single player as well. As a newly
              bootcamp graduated, I am excited to dive into what lays ahead,
              learning all that I can along the way!{" "}
            </p>
