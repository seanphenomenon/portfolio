                ...
                <div className='w-100'>
                    ...
                    <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div className="p-2">
                            ...
                            <p>• Provided excellent customer service in a fast-paced environment <br />
                                ...
                                • Helped development project managers and customers with the intake of project re-submittals<br />
                                • Utilized the Project Tracking System to set-up new projects, analyze situations, and provide a variety of project status updates to agents<br />
                    ...
                    <div className='p-2'>
                        ...
                        <p>• Provided primary front desk coverage and support services for Vice Chancellor of Instructional Services<br/>
...
• Maintained communication with other district departments and personnel to exchange information and meet objectives<br/>
• Processed invoices and arranged for the acquisition of office supplies, materials and consultant services.<br/>
