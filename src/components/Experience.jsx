            ...
            <div className="d-flex flex-column flex-md-row justify-content-center mb-5">
              <div className="p-2">
                ...
                <p id="experience-info">
                  ...
                  <br />
                  • Conducted grant analysis research and developed grant
                  tracking spreadsheets in support of quarterly districtwide
                  grant reporting and annual presentation of grants and
                  contracts to the Board of Trustees.
                  <br />
                  • Monitored budgets, purchases, and expenditures for
                  department through PeopleSoft and Excel
                  <br />
                </p>
              </div>
              <div
