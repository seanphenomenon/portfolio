            ...
            <div>
                ...
                <div className='w-100'>
                    ...
                    <div className="d-flex flex-column flex-md-row justify-content-center mb-5">
                        <div className="p-2">
                            ...
                            <p id='experience-info'>
                                ...
                                • Utilized the Project Tracking Software to set-up new projects, analyze situations, and provide a variety of project status updates to agents<br />
                    ...
                    <div className='p-2'>
                        ...
                        <p id='experience-info'>
                        • Provided primary front desk coverage and support services for Vice Chancellor of Instructional Services<br/>
